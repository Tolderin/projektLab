...
public class Cleaner extends Player {
     ...
     * mar takaritott savok pontszamitasa hivja. Az osszevonott
     * elvonas miatt int-tipusu osszeget delegal a
     * Player.addMoney(double) os-metodusra; igy a
     * notifyObservers("moneyChanged") automatikusan lefut.
     *
     * @param amount A jutalom merteke.
     */
    public void addMoney(int amount) {
        super.addMoney((double) amount);
    }
